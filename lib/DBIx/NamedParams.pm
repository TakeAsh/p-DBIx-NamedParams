...
When the SQL statement has the variable array C<:<Name>+-<Type>>, the hash reference as the second argument is mandatory.
When the SQL statement doesn't have the variable array C<:<Name>+-<Type>>, the hash reference as the second argument is optional.
